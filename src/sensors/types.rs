...
#[derive(Format, Clone, Serialize, Default)]
pub struct DataPacket {
    pub battery_voltage: u16, // unit: mV
    pub env_data: crate::sensors::onboard::environment::EnvironmentData,
    pub probe_data: crate::sensors::probe::soil::soil_sensor::ProbeData,
}
